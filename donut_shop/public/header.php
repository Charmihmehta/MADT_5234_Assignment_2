...
<html>
  ...
  <body>
    ...
    <!-- MENU -->
    <nav class="level">
      <p id="about_us_page" class="level-item has-text-centered">
        <a href="about.php" class="link is-info">About Us</a>
      </p>
      <p id="location_page" class="level-item has-text-centered">
        <a href="locations.php" class="link is-info">Locations</a>
      </p>
      <p id="index_page" class="level-item has-text-centered">
        <a href="index.php">
    	     <img src="images/logo-donut.png" class="logo">
         </a>
      </p>
      <p id="menu_page" class="level-item has-text-centered">
        <a href="menu.php" class="link is-info">Menu</a>
      </p>
      <p id="cart_page" class="level-item has-text-centered">
